...
Scene daltons() {
    ...
    auto sphere1 =
        std::make_shared<Sphere>(glm::vec3(6.16, 0.66, 1), glm::vec3(1, 1, 1), 1, 0, 1, 0.8, 0.22);
    auto sphere2 =
    ...
    auto sphere4 = std::make_shared<Sphere>(glm::vec3(5.25, 3, 0.66), glm::vec3(1, 1, 1), 0.25,
                                            0.5, 1.5, 0, 0.05);
    auto camera = std::make_shared<Camera>(glm::vec3(5, 5, 0.66), glm::vec3(0, -1, 0), 0.1, 0.1, 1000, 1000, 0.05);
    auto lightSource = std::make_shared<DirectLight>(glm::vec3(5, 2.5, 3), glm::vec3(1, 1, 1), 2000);
