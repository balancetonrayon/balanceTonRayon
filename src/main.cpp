...
void test()
{
    ...
    auto plane = std::make_shared<Plane>(glm::vec3(0, 0, 1), glm::vec3(1, 1, 1), 0, 1, 0.10);
    auto sphere1 = std::make_shared<Sphere>(glm::vec3(5, 1.1, 3), 0.25, 0.18);
    auto sphere2 = std::make_shared<Sphere>(glm::vec3(5, 1.1, 1.5), 1, 0, 1, 0.15);
    auto sphere3 = std::make_shared<Sphere>(glm::vec3(5, -1.1, 1.5), 1, 0, 1, 0.22);
